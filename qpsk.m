...
Plot.ModSignal   = 1;               % plot modulated MPSK signal
...
Plot.Histogram3D = 1;               % plot 3D histogram
Plot.Scatterplot = 0;               % plot scatterplot w/o errors
Plot.SymErrors   = 1;               % plot scatterplot w/ errors
